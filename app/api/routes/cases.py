...
# from app.schemas.case import CaseResponse, CaseRequest, CaseRead,CaseSummaryApproveRequest
...
# # ==========================================
# # DELETE: SOFT DELETE CASE not working 
# # ==========================================
# @router.delete(
#     "/{case_id}", 
#     status_code=status.HTTP_200_OK,
...
from app.api.dependencies import get_db_session, get_legal_service, get_kanoon_service
from app.schemas.case import CaseDetailRead, CaseResponse, CaseRequest, CaseRead, CaseSummaryApproveRequest, CaseListRead, CaseDetailRead
from app.schemas.section import ChargesActionRequest, NewChargeRequest
from app.schemas.precedent import PrecedentRead
from app.services.legal_service import LegalAnalysisService
from app.services.kanoon_service import KanoonService

# Import the new controller logic
...
async def create_draft_case(
    ...
    return await case_controller.create_draft_case_controller(request, db, legal_service)
...
async def approve_summary_and_extract(
    ...
    return await case_controller.approve_summary_and_extract_controller(case_id, request, db, legal_service)
...
async def add_manual_charge(
    ...
    return await case_controller.add_manual_charge_controller(case_id, request, db)
...
async def finalize_charges_status(
    ...
    return await case_controller.finalize_charges_status_controller(case_id, request, db)
...
async def fetch_and_store_precedents(
    ...
    return await case_controller.fetch_and_store_precedents_controller(case_id, db, kanoon_service)
...
async def get_case_precedents(
    ...
    return await case_controller.get_case_precedents_controller(case_id, db)
